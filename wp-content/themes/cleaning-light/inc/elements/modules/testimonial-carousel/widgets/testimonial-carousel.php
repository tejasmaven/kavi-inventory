...
namespace CleaningLightElements\Modules\TestimonialCarousel\Widgets;
...
class TestimonialCarousel extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Testimonial Carousel', 'cleaning-light');
    }
    ...
    public function get_keywords() {
		return [ 'testimonial', 'carousel', 'client', 'review', 'feedback' ];
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'imageheight', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .cleaninglight-testimonial-wrapper.style3 .cleaninglight-testimonial-top-content img,
                        {{WRAPPER}} .cleaninglight-testimonial-wrapper.style4 .cleaninglight-testimonial-top-content img, 
                ...
                'testimonial_block_items', [
                    ...
                    'default' => [
                        [
                            ...
                            'content' => esc_html__('End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'cleaning-light'),
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
            ...
            $this->add_control(
                'quote',[
                    ...
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'condition' => ['layout' => ['style2','style6']],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'slides_to_show', [
                    'label' => esc_html__('Testimonial Items', 'cleaning-light'),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 2,
            ...
            $this->add_control(
                'slides_margin', [
                    'label' => esc_html__('Spacing Testimonial Item', 'cleaning-light'),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
    ...
    protected function render() {
        ...
        ?>
        <div class="cleaninglight-testimonial-carousel owl-carousel carouseldots" data-params='<?php echo $params; ?>'>
                ...
                <<?php Utils::print_validated_html_tag( $wrapper_tag ); ?> <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
                    ...
                    <?php else: ?>
                        <<?php Utils::print_validated_html_tag( $wrapper_tag ); ?> <?php $this->print_render_attribute_string( 'top_content' ); ?>>
                            ...
                            <?php if( $settings['layout'] &&  $settings['layout'] =='style4' ): if ( ! empty( $testimonialitem['name'] ) ) : ?>
                                <<?php Utils::print_validated_html_tag( $title_tag ); ?> <?php $this->print_render_attribute_string( 'title' ); ?>>
                                    <?php $this->print_unescaped_setting( 'name', 'testimonial_block_items', $testimonialindex ); ?>
                                </<?php Utils::print_validated_html_tag( $title_tag ); ?>>
                            <?php endif; endif; ?>
